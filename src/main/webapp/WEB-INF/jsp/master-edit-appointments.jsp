...
<div id="login">
        <form action="/master/master-edit-appointment" method="post">
            <fieldset class="clearfix">
                <p><span class="fontawesome-user"></span><input disabled type="text" value="${appointment.client.name}" placeholder="<fmt:message key="customerName"/>: "></label></p>
                <p><span class="fontawesome-calendar"></span><input disabled type="datetime-local" placeholder="<fmt:message key="date"/>" value="${appointment.localDateTime}"/></p>
                <p><span class="fontawesome-file-alt"></span><select name="status" size="1">
